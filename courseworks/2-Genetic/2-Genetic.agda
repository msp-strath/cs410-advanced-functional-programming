...
open import Data.Maybe.Base using (Maybe; just; nothing; fromMaybe; maybe′)
...
------------------------------------------------------------------------
  ...
  -- Some useful imports to use Haskell-style mapA (aka traverse)
  -- to execute some effect over a list or a vector of values
  import Data.List.Effectful as List
